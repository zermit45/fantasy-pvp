...
function scoreEntryFor(entry,eng,ctx){
  ...
  return {username:entry.username,total:finalTotal,boost:boostTokens,boostPct,boostChips:Array.isArray(chips)?chips:null,boostMult,view,captain:entry.captain,tactic:entry.tactic,subOut,squadSum:sq};// TIME IDEAL — a escalação que teria dado a MAIOR pontuação possível
