...
function roomHTML(){
  ...
  return `<div class="scorebar">
    ...
    <div class="score disp">
      <div class="side"><div class="fl">${flagOf(pp.home.code)}</div><div class="cd">${esc(pp.home.code)}</div><div class="nmfull">${esc(pp.home.name)}</div><div class="elo">ELO ${pp.home.elo}</div></div>
      <div class="vs mono">${finished?m.score[0]+"–"+m.score[1]:"VS"}</div>
      <div class="side"><div class="fl">${flagOf(pp.away.code)}</div><div class="cd">${esc(pp.away.code)}</div><div class="nmfull">${esc(pp.away.name)}</div><div class="elo">ELO ${pp.away.elo}</div></div>
    </div></div>
  <div class="card">
