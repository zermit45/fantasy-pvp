...
const TEAM_COLOR={
  // ===== SELEÇÕES =====
  POR:"#D52B1E", COD:"#007FFF", AUT:"#ED2939", JOR:"#007A3D", NED:"#FF6A00", NLD:"#FF6A00",
  JPN:"#0B1F8C", UZB:"#1EB53A", COL:"#FCD116", GHA:"#006B3F", PAN:"#DA121A", ENG:"#D9E2EC",
  CRO:"#E2001A", BRA:"#FCDD09", ARG:"#6CACE4", FRA:"#1A2A6C", ESP:"#C60B1E", GER:"#2A2F3A", DEU:"#2A2F3A",
  CZE:"#D7141A", RSA:"#007A4D", MEX:"#006847", KOR:"#CD2E3A", SUI:"#D52B1E", CHE:"#D52B1E",
  BIH:"#002F6C", CAN:"#FF0000", QAT:"#8A1538", SCO:"#0065BF", MAR:"#C1272D", HAI:"#00209F", HTI:"#00209F",
  USA:"#0A3161", AUS:"#FCD116", TUR:"#E30A17", PAR:"#D52B1E", PRY:"#D52B1E", ECU:"#FFD100",
  CUW:"#0033A0", CIV:"#FF8200", SWE:"#FFCD00", TUN:"#E70013", BEL:"#E30613", IRN:"#239F40",
  NZL:"#2A2F3A", EGY:"#CE1126", SAU:"#006C35", KSA:"#006C35", URU:"#5CBFEB", CPV:"#003893",
  ALG:"#007A3D", DZA:"#007A3D", NOR:"#BA0C2F", IRQ:"#007A3D", SEN:"#00853F",
  // ===== CLUBES (Brasileirão) =====
  FLA:"#C52613", FLU:"#7A1530", PAL:"#006437", COR:"#0E6B3D", COI:"#1A1A1A", SAO:"#E4002B",
  SAN:"#1A1A1A", VAS:"#1A1A1A", CAM:"#1A1A1A", ATM:"#D2122E", CRU:"#003DA5", GRE:"#0D80BF",
  INT:"#E10600", BAH:"#005CA9", BOT:"#1A1A1A", VIT:"#E2001A", MIR:"#1FA85A", RBB:"#E2001A",
  REM:"#005CA9", CHA:"#1FA85A"
}
